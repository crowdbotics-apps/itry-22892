...
admin.site.site_header = "ITry"
admin.site.site_title = "ITry Admin Portal"
admin.site.index_title = "ITry Admin"

# swagger
api_info = openapi.Info(
    title="ITry API",
    default_version="v1",
    description="API documentation for ITry App",
)
